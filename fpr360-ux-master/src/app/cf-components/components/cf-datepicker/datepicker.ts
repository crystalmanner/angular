...
/** Change event object emitted by Cf2Select. */
export class CfDateChange {
  constructor(public source: CfDatepickerComponent, public value: Date) {}
}
 ...
 * CfCalendar directly as the content so we can control the initial focus. This also gives us a
...
@Component({
  moduleId: module.id,
  selector: 'cf-datepicker-content',
  templateUrl: 'datepicker-content.html',
  styleUrls: ['datepicker-content.scss'],
  host: {
    class: 'cf-datepicker-content',
    '[class.cf-datepicker-content-touch]': 'datepicker?.touchUi',
    '(keydown)': '_handleKeydown($event)'
  },
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class CfDatepickerContentComponent {
  datepicker: CfDatepickerComponent;

  @ViewChild(CfCalendarComponent) _calendar: CfCalendarComponent;
...
export const CF_DATEPICKER_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => CfDatepickerComponent),
  multi: true
};

export const CF_DATEPICKER_VALIDATORS: any = {
...
@Component({
  ...
  providers: [CF_DATEPICKER_VALUE_ACCESSOR, CF_DATEPICKER_VALIDATORS],
  host: {
    role: 'datepicker',
    '[class.cf-datepicker-disabled]': 'disabled',
    '[class.cf-datepicker-opened]': 'opened',
...
export class CfDatepickerComponent implements OnDestroy, ControlValueAccessor {
    ...
    return (
      ...
      (this.type === 'month'
        ...
        : this.type === 'date'
          ...
          : this.type === 'time'
            ? 'HH:mm'
            : this.type === 'datetime' ? 'dd/MM/y HH:mm' : 'dd/MM/y')
    );
  }
  ...
  @Input()
  set dateFilter(filter: (date: Date | null) => boolean) {
  ...
  @Output()
  change: EventEmitter<CfDateChange> = new EventEmitter<CfDateChange>();
  ...
  private _calendarPortal: ComponentPortal<CfDatepickerContentComponent>;
  ...
  private _minValidator: ValidatorFn = (
    ...
    return !this.min ||
      ...
      ? null
      : { cfDatepickerMin: { min: this.min, actual: control.value } };
  };
  ...
  private _maxValidator: ValidatorFn = (
    ...
    return !this.max ||
      ...
      ? null
      : { cfDatepickerMax: { max: this.max, actual: control.value } };
  };
  ...
  constructor(
    ...
    this.id = this.id ? this.id : `cf-datepicker-${datepickerUid++}`;
  }
  ...
  _handleBlur(event: Event) {
    ...
    if (date != null && date.getTime && !isNaN(date.getTime())) {
      const d: Date = new Date(this.value);
      if (this.type !== 'time') {
  ...
  _emitChangeEvent(): void {
    ...
    this.change.emit(new CfDateChange(this, this.value));
  }
