...
@Component({
  selector: 'app-company-merchants',
  templateUrl: './company-merchants.component.html',
  styleUrls: ['./company-merchants.component.scss']
})
export class CompanyMerchantsComponent implements OnInit {
  companyMerchantsData = {
    rows: [
      {
        icon: {
          iconName: '',
