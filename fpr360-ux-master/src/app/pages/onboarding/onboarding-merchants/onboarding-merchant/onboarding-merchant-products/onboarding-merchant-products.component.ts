...
@Component({
  selector: 'app-onboarding-merchant-products',
  templateUrl: './onboarding-merchant-products.component.html',
  styleUrls: ['./onboarding-merchant-products.component.scss']
})
export class OnboardingMerchantProductsComponent implements OnInit {
