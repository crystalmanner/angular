...
@Component({
  selector: 'app-onboarding-merchant-details',
  templateUrl: './onboarding-merchant-details.component.html',
  styleUrls: ['./onboarding-merchant-details.component.scss']
})
export class OnboardingMerchantDetailsComponent implements OnInit {
  merchantDetails = {
    countryValue: 'USA',
    industry: [
      {
