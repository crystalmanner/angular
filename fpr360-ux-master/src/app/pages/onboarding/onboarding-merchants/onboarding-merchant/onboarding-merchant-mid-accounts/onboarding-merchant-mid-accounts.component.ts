...
@Component({
  selector: 'app-onboarding-merchant-mid-accounts',
  templateUrl: './onboarding-merchant-mid-accounts.component.html',
  styleUrls: ['./onboarding-merchant-mid-accounts.component.scss']
})
export class OnboardingMerchantMidAccountsComponent implements OnInit {
  midAccountsData = {
    rows: [
      {
        icon: {
