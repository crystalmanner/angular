...
@Component({
  selector: 'app-onboarding-gurus',
  templateUrl: './onboarding-gurus.component.html',
  styleUrls: ['./onboarding-gurus.component.scss']
})
export class OnboardingGurusComponent implements OnInit {
  gurusData = {
    rows: [
      {
        icon: {
