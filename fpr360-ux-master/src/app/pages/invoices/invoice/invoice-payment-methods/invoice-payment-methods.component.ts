...
@Component({
  selector: 'app-invoice-payment-methods',
  templateUrl: './invoice-payment-methods.component.html',
  styleUrls: ['./invoice-payment-methods.component.scss']
})
export class InvoicePaymentMethodsComponent implements OnInit {
