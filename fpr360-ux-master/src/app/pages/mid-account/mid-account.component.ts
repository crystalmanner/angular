...
@Component({
  selector: 'app-mid-account',
  templateUrl: './mid-account.component.html',
  styleUrls: ['./mid-account.component.scss']
})
export class MidAccountComponent implements OnInit {
  ...
  processor = {
    account: {
      ...
      disputeMethodEmail: 'example@email.com',
