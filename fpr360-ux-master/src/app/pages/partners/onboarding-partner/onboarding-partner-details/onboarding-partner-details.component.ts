...
@Component({
  selector: 'app-onboarding-partner-details',
  templateUrl: './onboarding-partner-details.component.html',
  styleUrls: ['./onboarding-partner-details.component.scss']
})
export class OnboardingPartnerDetailsComponent implements OnInit {
  readonly = false;
  data = {
    companyInfo: {
      roleValue: '',
