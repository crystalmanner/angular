...
@Component({
  selector: 'app-onboarding-partner-reports',
  templateUrl: './onboarding-partner-reports.component.html',
  styleUrls: ['./onboarding-partner-reports.component.scss']
})
export class OnboardingPartnerReportsComponent implements OnInit {
  rootCauseReportList = [
    {
